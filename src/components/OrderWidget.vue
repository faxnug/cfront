  ...
  <div class="orderForm">
    <el-form label-width="80px">
      ...
      <el-form-item label="价格">
        <el-input-number v-model="price" controls-positions="right" :step="0.01" :min="0.01"></el-input-number>
      </el-form-item>
      <el-form-item label="数量">
        <el-input-number :label="(direction === 0 ? '买入' : '卖出') + '(股)'" v-model="volume" controls-positions="right" :step="100"
          :min="0" :max="affordCount"></el-input-number>
      </el-form-item>
      <el-form-item label="">
