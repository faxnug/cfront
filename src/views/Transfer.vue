        ...
        <el-form label-width="80px">
          <el-form-item label="转账方式">
            <el-select style="width: 100%" v-model="type">
              <el-option v-for="item in form.type" :key="item.id" :label="item.name" :value="item.id" />
            </el-select>
          </el-form-item>
          <el-form-item label="选择银行">
            <el-select style="width: 100%" v-model="bank">
              <el-option v-for="item in form.bank" :key="item.id" :label="item.name" :value="item.name" />
            </el-select>
          </el-form-item>
          ...
          <el-form-item>
            <el-button style="float: center" size="small" type="primary">转账</el-button>
          </el-form-item>
        </el-form>
      </el-row>
    </el-card>
